...
public class ContactActivity extends Activity {
	...
	private static final String ID = "id", NAME = "name",
			...
			PHONENO3 = "phoneNo3", PHONENO4 = "phoneNo4",
			PHONENAME1 = "phoneName1", PHONENAME2 = "phoneName2",
			PHONENAME3 = "phoneName3", PHONENAME4 = "phoneName4",
				...
				if (m.matches()) {
					...
					if (cursor_contact1.getCount() != 0) {
						...
						for (int i = 0; i < cursor_contact1.getCount(); i++) {
							if (cursor_contact1.getString(3).equals(dept_Id)
									&& cursor_contact1.getString(5).contains(
								...
								cv.put(PHONENO1, cursor_contact1.getString(5));
								cv.put(PHONENO2, cursor_contact1.getString(6));
								cv.put(PHONENO3, cursor_contact1.getString(7));
								cv.put(PHONENO4, cursor_contact1.getString(8));
								cv.put(PHONENAME1, cursor_contact1.getString(9));
								cv.put(PHONENAME2,
										cursor_contact1.getString(10));
								cv.put(PHONENAME3,
										cursor_contact1.getString(11));
								cv.put(PHONENAME4,
										cursor_contact1.getString(12));
								list.add(cv);
							}
					...
					if (cursor_contact.getCount() != 0) {
						...
						for (int i = 0; i < cursor_contact.getCount(); i++) {
							if (cursor_contact.getString(3).equals(dept_Id)
									&& cursor_contact.getString(1).contains(
											put_search.getText().toString())) {
								ContentValues cv = new ContentValues();
								...
								cv.put(PHONENO1, cursor_contact.getString(5));
								cv.put(PHONENO2, cursor_contact.getString(6));
								cv.put(PHONENO3, cursor_contact.getString(7));
								cv.put(PHONENO4, cursor_contact.getString(8));
...
//			holder.number.setText(user_number);
			...
			convertView.setOnClickListener(new mmContactAdapterListener(
					...
					cv.getAsString(MAIL), cv.getAsString(DEPTNAME), cv
							.getAsString(PHONENO1), cv.getAsString(PHONENO2),
					cv.getAsString(PHONENO3), cv.getAsString(PHONENO4), cv
							.getAsString(PHONENAME1), cv
							.getAsString(PHONENAME2), cv
							.getAsString(PHONENAME3), cv
							.getAsString(PHONENAME4)));
			return convertView;
		}
		...
		class mmContactAdapterListener implements OnClickListener {
			...
			public mmContactAdapterListener(int pos, String _id, String _name,
					String _deptid, String _mail, String _deptname,
					String _phoneNo1, String _phoneNo2, String _phoneNo3,
					String _phoneNo4, String _phoneName1, String _phoneName2,
					String _phoneName3, String _phoneName4) {
			...
			try {
				...
				for (int i = 0; i < contactlist.getPropertyCount(); i++) {
					...
					for (int j = 0; j < soapchilds.getPropertyCount(); j++) {
						...
						// .toString();
						String phoneNo1 = soapchildsson.getProperty("phoneNo1")
								.toString();
						String phoneNo2 = soapchildsson.getProperty("phoneNo2")
								.toString();
						String phoneNo3 = soapchildsson.getProperty("phoneNo3")
								.toString();
						String phoneNo4 = soapchildsson.getProperty("phoneNo4")
								.toString();
						String phoneName1 = soapchildsson.getProperty(
								"phoneName1").toString();
						String phoneName2 = soapchildsson.getProperty(
								"phoneName2").toString();
						String phoneName3 = soapchildsson.getProperty(
								"phoneName3").toString();
						String phoneName4 = soapchildsson.getProperty(
								"phoneName4").toString();
