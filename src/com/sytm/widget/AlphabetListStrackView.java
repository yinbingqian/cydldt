...
public class AlphabetListStrackView extends RelativeLayout{
	...
	public AlphabetListStrackView(Context context) {
		super(context);
		init(context);
	}

	public AlphabetListStrackView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
		...
		mContext = context;
		LayoutInflater.from(context).inflate(R.layout.alphabet_liststrack,
				this, true);
	...
	public void onRefreshComplete() {
		Log.i("杩涘叆", "onRefreshComplete");
		mListView.onRefreshComplete();
	}

	// 鍒濆鍖栨眽璇嫾闊抽瀛楁瘝寮瑰嚭鎻愮ず妗�
	...
	// long arg3) {
	// ContactsActivity.longhandler.sendEmptyMessage(arg2);
	// return false;
	// }
}
