...
import com.lnpdit.chatuidemo.adapter.ContactAdapter;
...
import com.lnpdit.chatuidemo.widget.Sidebar;
...
public class ContactlistFragment extends Fragment {
	...
	private void getContactList() {
		contactList.clear();
		Map<String, User> users = CydlApplication.getInstance().getContactList();
