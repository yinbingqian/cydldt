...
public class AlphabetListReportView extends RelativeLayout{
	...
	public AlphabetListReportView(Context context) {
		super(context);
		init(context);
	}

	public AlphabetListReportView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
